...
const LoginHeroSection = ({ isLogin = true }) => {
  return (
    <div
      className={`w-full min-h-[90vh] px-3 mb-44 pt-5 bg-primary relative text-white bg-center bg-no-repeat bg-cover flex items-start justify-center ${!isLogin && "!items-center !min-h-screen !pb-10 !pt-0"}`}
      style={{
